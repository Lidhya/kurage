...
const Dashboard = ({ selectedNavItem }) => {
  return (
    <div
      className="h-screen"
      style={{ backgroundImage: `url(${bg})`, backgroundSize: "cover" }}
    >
      <div className="box-border px-4 bg-navColor h-[51px] flex items-center justify-between">
        ...
        <h2 className="text-white opacity-[60%]">{selectedNavItem}</h2></div>
